...
async def send_doc(client,message):
       ...
       if update_channel :
       	try:
       		...
       		[[InlineKeyboardButton("🔥  𝙹𝙾𝙸𝙽  𝚄𝙿𝙳𝙰𝚃𝙴  𝙲𝙷𝙰𝙽𝙽𝙴𝙻  🔥" ,url=f"https://telegram.me/{update_channel}")],[InlineKeyboardButton('🔥 MAIN CHANNEL 🔥', url='https://t.me/+6vOySosoIqUzMzhl')],[InlineKeyboardButton('🔥 DATABASE CHANNEL 🔥', url='https://t.me/+JA6WfwHzHGhhMTVl')]]))                                                                                         
       		return
       try:
